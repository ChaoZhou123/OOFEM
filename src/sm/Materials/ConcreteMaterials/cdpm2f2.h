...
///@name Input fields for CDPM2F2
//@{
#define _IFT_CDPM2F2_Name "cdpm2f2"
#define _IFT_CDPM2F2_fc "fc"
#define _IFT_CDPM2F2_ft "ft"
#define _IFT_CDPM2F2_ecc "ecc"
#define _IFT_CDPM2F2_kinit "kinit"
#define _IFT_CDPM2F2_ahard "ahard"
#define _IFT_CDPM2F2_bhard "bhard"
#define _IFT_CDPM2F2_chard "chard"
#define _IFT_CDPM2F2_dhard "dhard"
#define _IFT_CDPM2F2_dilation "dilation"
#define _IFT_CDPM2F2_asoft "asoft"
#define _IFT_CDPM2F2_hp "hp"
#define _IFT_CDPM2F2_yieldtol "yieldtol"
#define _IFT_CDPM2F2_newtoniter "newtoniter"
#define _IFT_CDPM2F2_wf "wf"
#define _IFT_CDPM2F2_efc "efc"
#define _IFT_CDPM2F2_softeningType "stype"
#define _IFT_CDPM2F2_ftOne "ft1"
#define _IFT_CDPM2F2_wfOne "wf1"
#define _IFT_CDPM2F2_strengthratetype "sratetype"
#define _IFT_CDPM2F2_energyratetype "eratetype"
#define _IFT_CDPM2F2_deltatime "deltat"
#define _IFT_CDPM2F2_helem "helem"
#define _IFT_CDPM2F2_isoflag "isoflag"
 ...
 */
class CDPM2F2Status : public StructuralMaterialStatus
{
public:
    ...
    enum state_flag_values {
        ...
        CDPM2F2_Plastic,
        CDPM2F2_Damage,
        CDPM2F2_PlasticDamage,
        CDPM2F2_VertexCompression,
        CDPM2F2_VertexTension,
        CDPM2F2_VertexCompressionDamage,
        CDPM2F2_VertexTensionDamage
    };

    enum CDPM2F2_ReturnType {
        RT_Regular,
        RT_Tension,
        RT_Compression,
        RT_Auxiliary
...
protected:
    ...
    int state_flag = CDPM2F2Status::CDPM2F2_Elastic;
    int temp_state_flag = CDPM2F2Status::CDPM2F2_Elastic;

    int returnType = CDPM2F2Status::RT_Regular;
    int tempReturnType = CDPM2F2Status::RT_Regular;

    int returnResult = CDPM2F2Status::RR_NotConverged;
    int tempReturnResult = CDPM2F2Status::RR_NotConverged;
...
public:
    ...
    const char *giveClassName() const override { return "CDPM2F2Status"; }
 ...
 */
class CDPM2F2 : public StructuralMaterial
{
public:

protected:
    // moved to material status (openmp issue)
    // enum CDPM2F2_ReturnType { RT_Regular, RT_Tension, RT_Compression, RT_Auxiliary };
    // mutable CDPM2F2_ReturnType returnType = RT_Regular; /// FIXME These must be replaced with return values in function calls. Material models must never have mutable state. The existance of this variable breaks openmp support.

    // moved to material status (openmp issue)
    // enum CDPM2F2_ReturnResult { RR_NotConverged, RR_Converged };
    // mutable CDPM2F2_ReturnResult returnResult = RR_NotConverged; /// FIXME These must be replaced with return values in function calls. Material models must never have mutable state. The existance of this variable breaks openmp support.
    ...
    //Chao: These are the varialbes that you had in cdpm2f2
